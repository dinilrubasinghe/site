...
(() => {
    ...
    var Li = s(() => {
        window.tram = (function (e) {
            ...
            function i(l, p, _) {
                return "#" + ((1 << 24) | (l << 16) | (p << 8) | _).toString(16).slice(1);
            }
            function o() {}
            function a(l, p) {
            ...
            function c(l, p, _) {
                ...
                var T = _;
                return Tr.test(l) || !wt.test(l) ? (T = parseInt(l, 10)) : wt.test(l) && (T = 1e3 * parseFloat(l)), 0 > T && (T = 0), T === T ? T : _;
            }
            function f(l) {
            ...
            var v = (function (l, p, _) {
                    ...
                    function H(Q, le) {
                        ...
                        return (
                            ...
                            (G.open = function (Ce) {
                                if (((re = {}), w(Ce) ? (re = Ce.call(G, $e, he, G, Q)) : T(Ce) && (re = Ce), T(re))) for (var mr in re) p.call(re, mr) && ($e[mr] = re[mr]);
                ...
                h = {
                    ease: [
                        ...
                        function (l, p, _, T) {
                            var w = (l /= T) * l,
                                b = w * l;
                            return p + _ * (-2.75 * b * w + 11 * w * w + -15.5 * b + 8 * w + 0.25 * l);
                        },
                    ],
                    "ease-in": [
                        "ease-in",
                    ...
                    "ease-out": [
                        ...
                        function (l, p, _, T) {
                            var w = (l /= T) * l,
                                b = w * l;
                            return p + _ * (0.3 * b * w + -1.6 * w * w + 2.2 * b + -1.8 * w + 1.9 * l);
                        },
                    ],
                    "ease-in-out": [
                        "ease-in-out",
                    ...
                    "ease-in-out-quad": [
                        ...
                        function (l, p, _, T) {
                            return (l /= T / 2) < 1 ? (_ / 2) * l * l + p : (-_ / 2) * (--l * (l - 2) - 1) + p;
                        },
                    ],
                    "ease-in-cubic": [
                    ...
                    "ease-in-out-cubic": [
                        ...
                        function (l, p, _, T) {
                            return (l /= T / 2) < 1 ? (_ / 2) * l * l * l + p : (_ / 2) * ((l -= 2) * l * l + 2) + p;
                        },
                    ],
                    "ease-in-quart": [
                    ...
                    "ease-in-out-quart": [
                        ...
                        function (l, p, _, T) {
                            return (l /= T / 2) < 1 ? (_ / 2) * l * l * l * l + p : (-_ / 2) * ((l -= 2) * l * l * l - 2) + p;
                        },
                    ],
                    "ease-in-quint": [
                    ...
                    "ease-in-out-quint": [
                        ...
                        function (l, p, _, T) {
                            return (l /= T / 2) < 1 ? (_ / 2) * l * l * l * l * l + p : (_ / 2) * ((l -= 2) * l * l * l * l + 2) + p;
                        },
                    ],
                    "ease-in-sine": [
                    ...
                    "ease-out-expo": [
                        ...
                        function (l, p, _, T) {
                            return l === T ? p + _ : _ * (-Math.pow(2, (-10 * l) / T) + 1) + p;
                        },
                    ],
                    "ease-in-out-expo": [
                        "cubic-bezier(1, 0, 0, 1)",
                        function (l, p, _, T) {
                            return l === 0 ? p : l === T ? p + _ : (l /= T / 2) < 1 ? (_ / 2) * Math.pow(2, 10 * (l - 1)) + p : (_ / 2) * (-Math.pow(2, -10 * --l) + 2) + p;
                        },
                    ],
                    "ease-in-circ": [
                    ...
                    "ease-in-out-circ": [
                        ...
                        function (l, p, _, T) {
                            return (l /= T / 2) < 1 ? (-_ / 2) * (Math.sqrt(1 - l * l) - 1) + p : (_ / 2) * (Math.sqrt(1 - (l -= 2) * l) + 1) + p;
                        },
                    ],
                    "ease-in-back": [
                        "cubic-bezier(0.600, -0.280, 0.735, 0.045)",
                        function (l, p, _, T, w) {
                            return w === void 0 && (w = 1.70158), _ * (l /= T) * l * ((w + 1) * l - w) + p;
                        },
                    ],
                    "ease-out-back": [
                        "cubic-bezier(0.175, 0.885, 0.320, 1.275)",
                        function (l, p, _, T, w) {
                            return w === void 0 && (w = 1.70158), _ * ((l = l / T - 1) * l * ((w + 1) * l + w) + 1) + p;
                        },
                    ],
                    "ease-in-out-back": [
                        ...
                        function (l, p, _, T, w) {
                            return (
                                w === void 0 && (w = 1.70158),
                                (l /= T / 2) < 1 ? (_ / 2) * l * l * (((w *= 1.525) + 1) * l - w) + p : (_ / 2) * ((l -= 2) * l * (((w *= 1.525) + 1) * l + w) + 2) + p
                            );
                        },
                    ],
                },
                ...
                D = function (l) {
                    ...
                    var p,
                        ...
                        T = "",
                        w = l.split("-");
                    for (p = 0; p < w.length; p++) T += w[p].charAt(0).toUpperCase() + w[p].slice(1);
                    for (p = 0; p < y.length; p++) if (((_ = y[p] + T), _ in x.style)) return { dom: _, css: L[p] + l };
                },
                F = (t.support = {
            ...
            if (F.transition) {
                var j = F.timing.dom;
                if (((x.style[j] = h["ease-in-back"][0]), !x.style[j])) for (var z in g) h[z][0] = g[z];
            }
            var ie = (t.frame = (function () {
                ...
                Ge = v(function (l) {
                    function p(k, ne) {
                        ...
                        if (!ne.weak || !this.props[oe]) {
                            var We = Ne[0],
                                xe = this.props[oe];
                            return xe || (xe = this.props[oe] = new We.Bare()), xe.init(this.$el, pe, Ne, ne), xe;
                        }
                    }
                    function _(k, ne, pe) {
                        if (k) {
                            var oe = typeof k;
                            if ((ne || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)), oe == "number" && ne))
                                return (this.timer = new vt({ duration: k, context: this, complete: b })), void (this.active = !0);
                            if (oe == "string" && ne) {
                                switch (k) {
                                    case "hide":
                                        G.call(this);
                            ...
                            if (oe == "object") {
                                ...
                                $e.call(
                                    ...
                                    he.call(this),
                                    Ne > 0 && ((this.timer = new vt({ duration: Ne, context: this })), (this.active = !0), ne && (this.timer.complete = b));
                                var We = this,
                                    xe = !1,
                                    an = {};
                                ie(function () {
                    ...
                    function T(k) {
                        (k = c(k, 0)), this.active ? this.queue.push({ options: k }) : ((this.timer = new vt({ duration: k, context: this, complete: b })), (this.active = !0));
                    }
                    function w(k) {
                        return this.active
                    ...
                    function $e(k, ne, pe) {
                        ...
                        for (oe in k)
                            (We = k[oe]),
                                oe in fe
                                    ? (ge.transform || (ge.transform = {}), (ge.transform[oe] = We))
                                    : (A.test(oe) && (oe = r(oe)), oe in V ? (ge[oe] = We) : (xe || (xe = {}), (xe[oe] = We)));
                        for (oe in ge) {
                    ...
                    function Ue(k, ne) {
                        l[k] = function () {
                            return this.children ? tI.call(this, ne, arguments) : (this.el && ne.apply(this, arguments), this);
                        };
                    }
                    function tI(k, ne) {
                        var pe,
                    ...
                    (l.init = function (k) {
                        ...
                        F.backface && ce.hideBackface && d(this.el, F.backface.css, "hidden");
                    }),
                        Ue("add", p),
                        Ue("start", _),
                        Ue("wait", T),
                ...
                Y = v(function (l) {
                    ...
                    function T(b) {
                        ...
                        return (H ? i(H[1], H[2], H[3]) : b).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3");
                    }
                    ...
                    (l.init = function (b, H, Q, le) {
                        ...
                        Q[2] && (G = Q[2]),
                            ...
                            ce.fallback || le.fallback
                                ...
                                : ((this.animate = this.transition),
                                  (this.string =
                                      this.name + K + this.duration + "ms" + (this.ease != "ease" ? K + h[this.ease][0] : "") + (this.delay ? K + this.delay + "ms" : "")));
                    }),
                        (l.set = function (b) {
                        ...
                        (l.transition = function (b) {
                            (this.active = !0),
                                ...
                                this.auto && (this.el.style[this.name] == "auto" && (this.update(this.get()), this.redraw()), b == "auto" && (b = p.call(this))),
                                (this.nextStyle = b);
                        }),
                        (l.fallback = function (b) {
                            var H = this.el.style[this.name] || this.convert(this.get(), this.type);
                            (b = this.convert(b, this.type)),
                                this.auto && (H == "auto" && (H = this.convert(this.get(), this.type)), b == "auto" && (b = p.call(this))),
                                (this.tween = new Rt({ from: H, to: b, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this }));
                        }),
                        (l.get = function () {
                            ...
                            switch (H) {
                                ...
                                case C:
                                    if (G) {
                                        ...
                                        if (H.test(b)) return b.charAt(0) == "#" && b.length == 7 ? b : T(b);
                                    }
                                    Q = "hex or rgb string";
                                    break;
                                case N:
                ...
                me = v(Y, function (l, p) {
                    l.init = function () {
                        p.init.apply(this, arguments), this.original || (this.original = this.convert(this.get(), C));
                    };
                }),
                bt = v(Y, function (l, p) {
                    (l.init = function () {
                ...
                Wt = v(Y, function (l, p) {
                    function _(T, w) {
                        var b, H, Q, le, G;
                        for (b in T) (le = fe[b]), (Q = le[0]), (H = le[1] || b), (G = this.convert(T[b], Q)), w.call(this, H, G, Q);
                    }
                    (l.init = function () {
                        p.init.apply(this, arguments),
                            this.current ||
                                ((this.current = {}),
                                fe.perspective && ce.perspective && ((this.current.perspective = ce.perspective), d(this.el, this.name, this.style(this.current)), this.redraw()));
                    }),
                        (l.set = function (T) {
                        ...
                        (l.transition = function (T) {
                            var w = this.values(T);
                            this.tween = new Ir({ current: this.current, values: w, duration: this.duration, delay: this.delay, ease: this.ease });
                            var b,
                                H = {};
                        ...
                        (l.values = function (T) {
                            ...
                            return (
                                _.call(this, T, function (H, Q, le) {
                                    (b[H] = Q), this.current[H] === void 0 && ((w = 0), ~H.indexOf("scale") && (w = 1), (this.current[H] = this.convert(w, le)));
                                }),
                                b
                            );
                        });
                ...
                Rt = v(function (l) {
                    ...
                    function _() {
                        var G,
                            ...
                            re,
                            he = Q.length;
                        if (he) for (ie(_), te = we(), G = he; G--; ) (re = Q[G]), re && re.render(te);
                    }
                    function T(G) {
                        var te,
                            re = e.inArray(G, Q);
                    ...
                    (l.init = function (G) {
                        ...
                        re === void 0 && (re = H.from),
                            he === void 0 && (he = H.to),
                            (this.unit = G.unit || ""),
                            typeof re == "number" && typeof he == "number" ? ((this.begin = re), (this.change = he - re)) : this.format(he, re),
                        ...
                        (l.render = function (G) {
                            ...
                            if (re < this.duration) {
                                ...
                                return (
                                    (te = this.startRGB ? b(this.startRGB, this.endRGB, he) : w(this.begin + he * this.change)),
                        ...
                        (l.format = function (G, te) {
                            if (((te += ""), (G += ""), G.charAt(0) == "#"))
                                return (this.startRGB = n(te)), (this.endRGB = n(G)), (this.endHex = G), (this.begin = 0), void (this.change = 1);
                            if (!this.unit) {
                                var re = te.replace(O, ""),
                                    he = G.replace(O, "");
                ...
                Ir = v(Rt, function (l, p) {
                    (l.init = function (_) {
                        ...
                        for (T in _.values)
                            (w = _.values[T]),
                                this.current[T] !== w &&
                                    this.tweens.push(new Rt({ name: T, from: this.current[T], to: w, duration: _.duration, delay: _.delay, ease: _.ease, autoplay: !1 }));
                        this.play();
                    }),
                        (l.render = function (_) {
                            var T,
                                ...
                                H = !1;
                            for (T = b; T--; ) (w = this.tweens[T]), w.context && (w.render(_), (this.current[w.name] = w.value), (H = !0));
            ...
            F.transform &&
                ...
                F.transform && F.backface && ((fe.z = [q, "translateZ"]), (fe.rotateZ = [M]), (fe.scaleZ = [I]), (fe.perspective = [N]));
            var Tr = /ms/,
                wt = /s|\./;
            return (e.tram = t);
        })(window.jQuery);
        ...
        hs.exports = (function () {
                    ...
                    e.forEach =
                        function (y, L, D) {
                            ...
                            if (E && y.forEach === E) y.forEach(L, D);
                                ...
                                for (var F = 0, j = y.length; F < j; F++) if (L.call(D, y[F], F, y) === t) return;
                            } else for (var z = e.keys(y), F = 0, j = z.length; F < j; F++) if (L.call(D, y[z[F]], z[F], y) === t) return;
                            return y;
                        });
            (e.map = e.collect =
                function (y, L, D) {
            ...
            (e.contains = e.include =
                ...
                (e.debounce = function (y, L, D) {
                    var F,
                        ...
                        Ge = function () {
                            var Te = e.now() - ie;
                            Te < L ? (F = setTimeout(Ge, L - Te)) : ((F = null), D || ((we = y.apply(z, j)), (z = j = null)));
                        };
                    return function () {
                        (z = this), (j = arguments), (ie = e.now());
                        var Te = D && !F;
                        return F || (F = setTimeout(Ge, L)), Te && ((we = y.apply(z, j)), (z = j = null)), we;
                    };
                }),
            ...
            return (
                (e.template = function (y, L, D) {
                    ...
                    var F = RegExp([(L.escape || U).source, (L.interpolate || U).source, (L.evaluate || U).source].join("|") + "|$", "g"),
                        j = 0,
                        z = "__p+='";
...
`);
                    var ie = L.variable;
                    if (ie) {
                        if (!x.test(ie)) throw new Error("variable is not a bare identifier: " + ie);
                    } else
                        (z =
                            `with(obj||{}){
` +
...
` +
    ...
    var Je = s(($U, As) => {
        ...
        function Is(e) {
            ae.env() && (Ze(e.design) && He.on("__wf_design", e.design), Ze(e.preview) && He.on("__wf_preview", e.preview)),
        ...
        var sn = navigator.userAgent.toLowerCase(),
            ms = (ae.env.touch = "ontouchstart" in window || (window.DocumentTouch && document instanceof window.DocumentTouch)),
            uI = (ae.env.chrome = /chrome/.test(sn) && /Google/.test(navigator.vendor) && parseInt(sn.match(/chrome\/(\d+)\./)[1], 10)),
    ...
    var Ns = s((JU, Cs) => {
        ...
        Gi.define(
            ...
            (Cs.exports = function (e, t, r) {
                if (((r = r || {}), (Gi.env("test") || Gi.env("frame")) && !r.fixture && !dI())) return { exit: 1 };
                var n = {},
                    i = e(window),
                ...
                E ? f() : a.search ? (/[?&](edit)(?:[=&?]|$)/.test(a.search) || /\?edit$/.test(a.href)) && f() : i.on(u, v).triggerHandler(u);
                function v() {
                ...
                function R(C, N) {
                    e.ajax({ type: "GET", url: C, dataType: "script", cache: !0 }).then(N, S);
                }
                function S(C, N, q) {
                ...
                function A(C) {
                    ...
                    var q = function (M) {
                        M.data === "WF_third_party_cookies_unsupported" ? (I(N, q), C(!1)) : M.data === "WF_third_party_cookies_supported" && (I(N, q), C(!0));
                    };
                    (N.onerror = function () {
                        I(N, q), C(!1);
                    }),
            ...
            (qs.exports = function () {
                function e(r) {
                    ...
                    function c(I) {
                        var C = I.type,
                            N = I.tagName;
                        return !!((N === "INPUT" && a[C] && !I.readOnly) || (N === "TEXTAREA" && !I.readOnly) || I.isContentEditable);
                    }
                    function f(I) {
            ...
            (xs.exports = function () {
                ...
                function n(a) {
                    ...
                    return (
                        ...
                        (/^input$/i.test(c) && /^(button|reset|submit|radio|checkbox)$/i.test(u.type) && !u.disabled) ||
                        (!/^(button|input|textarea|select|a)$/i.test(c) && !Number.isNaN(Number.parseFloat(u.tabIndex))) ||
                        /^audio$/i.test(c) ||
    ...
    var Gs = s((rW, Fs) => {
        ...
        var Xi = window.jQuery,
            ...
            ln = {
                ...
                intro: function (e, t) {
                    t.__wf_intro || ((t.__wf_intro = !0), Xi(t).triggerHandler(et.types.INTRO));
                },
                outro: function (e, t) {
                    t.__wf_intro && ((t.__wf_intro = null), Xi(t).triggerHandler(et.types.OUTRO));
                },
            };
        et.triggers = {};
    ...
    var Ws = s((iW, ct) => {
        ...
        (ct.exports = Wi), (ct.exports.__esModule = !0), (ct.exports.default = ct.exports);
    });
    var jt = s((oW, Or) => {
        var hI = Ws().default;
        function Bs(e) {
        ...
        function gI(e, t) {
            ...
            if (e === null || (hI(e) !== "object" && typeof e != "function")) return { default: e };
            var r = Bs(t);
        ...
        (Or.exports = gI), (Or.exports.__esModule = !0), (Or.exports.default = Or.exports);
    });
    var tt = s((aW, Sr) => {
        function _I(e) {
            return e && e.__esModule ? e : { default: e };
        }
        (Sr.exports = _I), (Sr.exports.__esModule = !0), (Sr.exports.default = Sr.exports);
    });
    var de = s((sW, Hs) => {
        var dn = function (e) {
    ...
    var Tu = s((OW, Iu) => {
        var yu = de(),
            ...
            ke,
            vn;
        _u && ((ke = _u.split(".")), (vn = ke[0] > 0 && ke[0] < 4 ? 1 : +(ke[0] + ke[1])));
        !vn && Yi && ((ke = Yi.match(/Edge\/(\d+)/)), (!ke || ke[1] >= 74) && ((ke = Yi.match(/Chrome\/(\d+)/)), ke && (vn = +ke[1])));
        Iu.exports = vn;
    });
    var Qi = s((SW, Ou) => {
        var mu = Tu(),
    ...
    var ro = s((xW, Uu) => {
        ...
        })("versions", []).push({ version: "3.19.0", mode: oT ? "pure" : "global", copyright: "\xA9 2021 Denis Pushkarev (zloirock.ru)" });
    });
    var Bu = s((DW, Wu) => {
        var aT = de(),
            sT = Ki(),
    ...
    var io = s((GW, Qu) => {
        ...
        Qu.exports = function (e) {
            if (!ku(zt, e) || !(Ku || typeof zt[e] == "string")) {
                var t = "Symbol." + e;
                Ku && ku(qt, e) ? (zt[e] = qt[e]) : Yu && zu ? (zt[e] = zu(t)) : (zt[e] = yT(t));
            }
            return zt[e];
        };
    });
    var ec = s((XW, Ju) => {
        ...
        Ju.exports = function (e, t) {
            ...
            var r = mT(e, bT),
                n;
            if (r) {
                if ((t === void 0 && (t = "default"), (n = TT(r, e, t)), !$u(n) || Zu(n))) return n;
    ...
    var Ac = s(($W, Sc) => {
        var sm = hc(),
            ...
            vm = function (e) {
                return function (t) {
                    var r;
                    if (!um(t) || (r = Nr(t)).type !== e) throw _o("Incompatible receiver, " + e + " required");
                    return r;
                };
            };
        sm || ho.state
    ...
    var Lc = s((JW, Pc) => {
        ...
        (Pc.exports = function (e, t, r, n) {
            ...
            if (
                (Cc(r) &&
                    (String(u).slice(0, 7) === "Symbol(" && (u = "[" + String(u).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
    ...
    var nl = s((dB, rl) => {
        ...
        rl.exports = function (e, t) {
            var r = e.target,
                ...
                f,
                E;
            if ((n ? (a = Ao) : i ? (a = Ao[r] || fO(r, {})) : (a = (Ao[r] || {}).prototype), a))
                for (u in t) {
                    if (((f = t[u]), e.noTargetGet ? ((E = uO(a, u)), (c = E && E.value)) : (c = a[u]), (o = pO(n ? u : r + (i ? "." : "#") + u, e.forced)), !o && c !== void 0)) {
    ...
    var sl = s((vB, al) => {
        ...
        al.exports = hO
            ...
            : function (t, r) {
                  _O(t);
                  for (var n = yO(r), i = IO(r), o = i.length, a = 0, u; o > a; ) gO.f(t, (u = i[a++]), n[u]);
                  return t;
              };
    });
    var cl = s((EB, ul) => {
    ...
    var gl = s((hB, hl) => {
        var mO = wr(),
            ...
            wO = function () {
                var e = bO("iframe"),
                    ...
                    r;
                return (
                    (e.style.display = "none"), AO.appendChild(e), (e.src = String(t)), (r = e.contentWindow.document), r.open(), r.write(El("document.F=Object")), r.close(), r.F
                );
            },
            mn,
            On = function () {
                ...
                On = typeof document < "u" ? (document.domain && mn ? pl(mn) : wO()) : pl(mn);
        ...
        hl.exports =
            ...
            function (t, r) {
                var n;
                return t !== null ? ((bo[Ro] = mO(t)), (n = new bo()), (bo[Ro] = null), (n[vl] = t)) : (n = On()), r === void 0 ? n : OO(n, r);
            };
    });
    var yl = s((gB, _l) => {
        var CO = io(),
    ...
    var _t = s((CB, Vl) => {
        ...
        function rS(e) {
            return e == null ? (e === void 0 ? tS : eS) : Xl && Xl in Object(e) ? ZO(e) : JO(e);
        }
        Vl.exports = rS;
    });
    var Po = s((NB, Ul) => {
    ...
    var Go = s((Lr) => {
        ...
        function $l(e, t, r) {
            ...
            function h(S) {
                if (!(0, mS.default)(S)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
            ...
            return h({ type: Yl.INIT }), (n = { dispatch: h, subscribe: v, getState: E, replaceReducer: g }), (n[zl.default] = R), n;
        }
    });
    var Vo = s((Xo) => {
        "use strict";
                ...
                if (typeof r(void 0, { type: i }) > "u")
                    throw new Error(
                        'Reducer "' +
                            ...
                            ("Don't try to handle " + Zl.ActionTypes.INIT + ' or other actions in "redux/*" ') +
    ...
    var of = s((Oe) => {
        ...
        var ZS = { CHILDREN: "CHILDREN", SIBLINGS: "SIBLINGS", IMMEDIATE_CHILDREN: "IMMEDIATE_CHILDREN" };
    ...
    var Ko = s((Zt) => {
        ...
        var rA = { ELEMENT: "ELEMENT", ELEMENT_CLASS: "ELEMENT_CLASS", TRIGGER_ELEMENT: "TRIGGER_ELEMENT" };
    ...
    var sf = s((An) => {
        ...
        var iA = Ko(),
            { TRANSFORM_MOVE: oA, TRANSFORM_SCALE: aA, TRANSFORM_ROTATE: sA, TRANSFORM_SKEW: uA, STYLE_SIZE: cA, STYLE_FILTER: lA, STYLE_FONT_VARIATION: fA } = iA.ActionTypeConsts,
            dA = { [oA]: !0, [aA]: !0, [sA]: !0, [uA]: !0, [cA]: !0, [lA]: !0, [fA]: !0 };
    ...
    var xr = s((JB, ft) => {
        ...
        (ft.exports = Zo), (ft.exports.__esModule = !0), (ft.exports.default = ft.exports);
    });
    var Jt = s((ve) => {
        "use strict";
                ...
                if (f != null) {
                    ...
                    if (E.length)
                        for (var v = 0; v <= E.length; v++) {
                            ...
                            if (!(e && n[h] !== void 0)) {
                                var g = f[h];
                                t && wn(n[h]) && wn(g) && (g = Me(e, t, n[h], g)), !(g === void 0 || g === n[h]) && (i || ((i = !0), (n = Cn(n))), (n[h] = g));
                            }
                        }
                }
            }
        ...
        function bf(e, t, r, n, i, o, a) {
            ...
            return E.length ? (c = Me.call.apply(Me, [null, !1, !1, u, r, n, i, o, a].concat(E))) : (c = Me(!1, !1, u, r, n, i, o, a)), Pn(e, t, c);
        }
        function Rf(e, t) {
    ...
    var Nf = s((Ln) => {
        ...
        var Hb = Bb(xr()),
            jb = De(),
            kb = Jt(),
            { IX2_PREVIEW_REQUESTED: Kb, IX2_PLAYBACK_REQUESTED: zb, IX2_STOP_REQUESTED: Yb, IX2_CLEAR_REQUESTED: Qb } = jb.IX2EngineActionTypes,
            $b = { preview: {}, playback: {}, stop: {}, clear: {} },
            Cf = Object.create(null, { [Kb]: { value: "preview" }, [zb]: { value: "playback" }, [Yb]: { value: "stop" }, [Qb]: { value: "clear" } }),
            Zb = (e = $b, t) => {
                if (t.type in Cf) {
                    let r = [Cf[t.type]];
    ...
    var Ad = s((CH, Sd) => {
        ...
        function NR(e, t) {
            var r = this.__data__;
            return (this.size += this.has(e) ? 0 : 1), (r[e] = wR && t === void 0 ? CR : t), this;
        }
        Sd.exports = NR;
    });
    var Rd = s((NH, bd) => {
    ...
    var Nd = s((qH, Cd) => {
        var wd = Rd(),
            ...
            FR = Mn();
        function GR() {
            (this.size = 0), (this.__data__ = { hash: new wd(), map: new (FR || MR)(), string: new wd() });
        }
        Cd.exports = GR;
    });
    var Pd = s((PH, qd) => {
    ...
    var Hd = s((XH, Bd) => {
        ...
        function ow(e, t) {
            ...
            if (r instanceof tw) {
                var n = r.__data__;
                if (!rw || n.length < iw - 1) return n.push([e, t]), (this.size = ++r.size), this;
    ...
    var Un = s((s5, xp) => {
        ...
        function OC(e, t) {
            var r = typeof e;
            return (t = t ?? TC), !!t && (r == "number" || (r != "symbol" && mC.test(e))) && e > -1 && e % 1 == 0 && e < t;
        }
        xp.exports = OC;
    });
    var Wn = s((u5, Dp) => {
    ...
    var Fp = s((c5, Mp) => {
        var bC = _t(),
            ...
            ue = {};
        ue[HC] = ue[jC] = ue[kC] = ue[KC] = ue[zC] = ue[YC] = ue[QC] = ue[$C] = ue[ZC] = !0;
        ue[CC] = ue[NC] = ue[WC] = ue[qC] = ue[BC] = ue[PC] = ue[LC] = ue[xC] = ue[DC] = ue[MC] = ue[FC] = ue[GC] = ue[XC] = ue[VC] = ue[UC] = !1;
        function JC(e) {
    ...
    var la = s((d5, jp) => {
        ...
        function EN(e, t) {
            ...
            for (var f in e)
                (t || vN.call(e, f)) &&
                    !(a && (f == "length" || (i && (f == "offset" || f == "parent")) || (o && (f == "buffer" || f == "byteLength" || f == "byteOffset")) || fN(f, c))) &&
                    u.push(f);
            return u;
        }
        jp.exports = EN;
    ...
    var rv = s((y5, tv) => {
        ...
        function XN(e, t, r, n, i, o) {
            ...
            if (S && !P) {
                var C = e.constructor,
                    N = t.constructor;
                C != N && "constructor" in e && "constructor" in t && !(typeof C == "function" && C instanceof C && typeof N == "function" && N instanceof N) && (S = !1);
            }
    ...
    var Sv = s((A5, Ov) => {
        ...
        function lq(e, t, r, n, i, o) {
            ...
            if (h && !E) return o || (o = new ga()), a || sq(e) ? iq(e, t, r, n, i, o) : oq(e, t, c, r, n, i, o);
            if (!(r & uq)) {
    ...
    var _a = s((b5, Rv) => {
        ...
        function bv(e, t, r, n, i) {
            return e === t ? !0 : e == null || t == null || (!Av(e) && !Av(t)) ? e !== e && t !== t : fq(e, t, r, n, bv, i);
        }
        Rv.exports = bv;
    });
    var Cv = s((R5, wv) => {
    ...
    var zn = s((L5, Fv) => {
        ...
        function Dq(e, t) {
            if (qq(e)) return !1;
            var r = typeof e;
            return r == "number" || r == "symbol" || r == "boolean" || e == null || Pq(e) ? !0 : xq.test(e) || !Lq.test(e) || (t != null && e in Object(t));
        }
        Fv.exports = Dq;
    });
    var Vv = s((x5, Xv) => {
    ...
    var sE = s((j5, aE) => {
        ...
        function gP(e, t, r) {
            ...
            return o || ++n != i ? o : ((i = e == null ? 0 : e.length), !!i && EP(i) && vP(a, i) && (pP(e) || dP(e)));
        }
        aE.exports = gP;
    });
    var cE = s((k5, uE) => {
    ...
    var It = s((Z5, _E) => {
        var VP = Dv(),
            ...
            HP = gE();
        function jP(e) {
            return typeof e == "function" ? e : e == null ? WP : typeof e == "object" ? (BP(e) ? UP(e[0], e[1]) : VP(e)) : HP(e);
        }
        _E.exports = jP;
    });
    var Sa = s((J5, yE) => {
    ...
    var ei = s((qe) => {
        ...
        qe.withBrowser = Jn;
        var SL = Jn(() =>
            (0, OL.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], (e) => e in Element.prototype)
        );
    ...
    var qa = s((Kr) => {
        ...
        function mx(e, t, r) {
            return t === 0 ? 0 : t === 1 ? 1 : Na(r ? (t > 0 ? r(t) : t) : t > 0 && e && BE[e] ? BE[e](t) : t);
        }
    });
    var KE = s((ur) => {
        "use strict";
        ...
        var ii = Jt(),
            ...
            { IX2_SESSION_STOPPED: Px, IX2_INSTANCE_ADDED: Lx, IX2_ELEMENT_STATE_CHANGED: xx } = jE.IX2EngineActionTypes,
            HE = {},
            Dx = "refState",
            Mx = (e = HE, t = {}) => {
                switch (t.type) {
                    ...
                    case Lx: {
                        let { elementId: r, element: n, origin: i, actionItem: o, refType: a } = t.payload,
                            { actionTypeId: u } = o,
                            c = e;
                        return (0, ii.getIn)(c, [r, n]) !== n && (c = kE(c, n, a, r, o)), Pa(c, r, u, i, o);
                    }
                    case xx: {
        ...
        function kE(e, t, r, n, i) {
            let o = r === Ox ? (0, ii.getIn)(i, ["config", "target", "objectId"]) : null;
    ...
    var ph = s((bj, dh) => {
        ...
        function RD(e, t, r) {
            ...
            if (!n) return -1;
            var i = n - 1;
            return r !== void 0 && ((i = SD(r)), (i = r < 0 ? AD(n + i, 0) : bD(i, n - 1))), mD(e, OD(t, 3), i, !0);
        }
        dh.exports = RD;
    });
    var Eh = s((Rj, vh) => {
    ...
    var gh = s((oi) => {
        ...
        function PD(e, t) {
            ...
            for (let i = 0; i < r.length; i++) if (!qD.call(t, r[i]) || !hh(e[r[i]], t[r[i]])) return !1;
            return !0;
        }
        var LD = PD;
        oi.default = LD;
    ...
    var Gh = s((se) => {
        ...
        var Tt = ui($E()),
            ...
            Lh = Object.freeze({ [Pe.TRANSFORM_PREFIXED]: MD, [wh]: DD, [ai]: ai, [zr]: zr, [ot]: ot, [at]: at, [Yr]: Yr }),
            mh = {},
            $D = 1;
        function ZD() {
            return "i" + $D++;
        ...
        function Ua({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
            ...
            let { targets: c } = e;
            if (Array.isArray(c) && c.length > 0) return c.reduce((D, F) => D.concat(Ua({ config: { target: F }, event: t, eventTarget: r, elementRoot: n, elementApi: i })), []);
            let {
                    getValidDocument: f,
                    getQuerySelector: E,
                    queryDocument: v,
                ...
                { target: O } = e;
            if (!O) return [];
            let { id: A, objectId: I, selector: C, selectorGuids: N, appliesTo: q, useEventTarget: M } = Oh(O);
            ...
            let B =
                    ((o = t == null || (a = t.action) === null || a === void 0 || (u = a.config) === null || u === void 0 ? void 0 : u.affectedElements) !== null && o !== void 0
                        ? o
                        : {})[A || C] || {},
                ee = !!(B.id || B.selector),
                K,
                ...
                y,
                L = t && E(Oh(t.target));
            if ((ee ? ((K = B.limitAffectedElements), (x = L), (y = E(B))) : (x = y = E({ id: A, selector: C, selectorGuids: N })), t && M)) {
                let D = r && (y || M === !0) ? [r] : v(L);
                if (y) {
        ...
        var Sh = /px/,
            oM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = vM[n.type]), r), e || {}),
            aM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = EM[n.type] || n.defaultValue || 0), r), e || {});
            ...
            switch (n.actionTypeId) {
                ...
                case pr: {
                    let u = o(e, ot),
                        ...
                        E;
                    return (
                        n.config.widthUnit === mt ? (f = Sh.test(u) ? parseFloat(u) : parseFloat(r.width)) : (f = (0, Tt.default)(parseFloat(u), parseFloat(r.width))),
                        n.config.heightUnit === mt ? (E = Sh.test(c) ? parseFloat(c) : parseFloat(r.height)) : (E = (0, Tt.default)(parseFloat(c), parseFloat(r.height))),
                ...
                case Er:
                case hr:
                    return bM({ element: e, actionTypeId: n.actionTypeId, computedStyle: r, getStyle: o });
                case ci:
        ...
        var Wa = {
            ...
            vM = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 }),
        ...
        function _M(e, t, r, n, i) {
            let o = gM
                    .map((u) => {
                        let c = Wa[u],
                            { xValue: f = c.xValue, yValue: E = c.yValue, zValue: v = c.zValue, xUnit: h = "", yUnit: g = "", zUnit: R = "" } = t[u] || {};
                        switch (u) {
                            case lr:
                    ...
                    .join(" "),
                { setStyle: a } = i;
            Gt(e, Pe.TRANSFORM_PREFIXED, i), a(e, Pe.TRANSFORM_PREFIXED, o), TM(n, r) && a(e, Pe.TRANSFORM_STYLE_PREFIXED, BD);
        }
        function yM(e, t, r, n) {
        ...
        function IM(e, t, r, n) {
            let i = (0, Fa.default)(t, (a, u, c) => (a.push(`"${c}" ${u}`), a), []).join(", "),
                { setStyle: o } = n;
            Gt(e, Yr, n), o(e, Yr, i);
        }
        ...
        function bM({ element: e, actionTypeId: t, computedStyle: r, getStyle: n }) {
            let i = Va[t],
                o = n(e, i),
                a = OM.test(o) ? o : r[i],
                u = AM(SM, a).split(Qr);
        ...
        function RM(e, t, r, n, i, o) {
            ...
            switch (n.actionTypeId) {
                case pr: {
                    ...
                    f !== void 0 && (u === mt && (u = "px"), Gt(e, ot, o), a(e, ot, f + u)), E !== void 0 && (c === mt && (c = "px"), Gt(e, at, o), a(e, at, E + c));
                    break;
                }
                case Zr: {
                    yM(e, r, n.config, o);
        ...
        function wM(e, t, r) {
            ...
            switch (t.actionTypeId) {
                case ci: {
                    ...
                    i === HD && Pe.IS_BROWSER_ENV ? n(e, si, Pe.FLEX_PREFIXED) : n(e, si, i);
                    return;
                }
            }
        }
        ...
        function bh({ actionGroup: e, event: t, elementApi: r }) {
            ...
            n.forEach(({ actionTypeId: i, config: o }) => {
                let a;
                (0, st.isPluginType)(i) ? (a = (0, st.clearPlugin)(i)) : (a = Mh({ effect: qM, actionTypeId: i, elementApi: r })),
        ...
        function qM(e, t, r) {
            let { setStyle: n } = r;
            Dh(e, t, r), n(e, t, ""), t === Pe.TRANSFORM_PREFIXED && n(e, Pe.TRANSFORM_STYLE_PREFIXED, "");
        }
        function Fh(e) {
            let t = 0,
                r = 0;
        ...
        function LM({ actionList: e, actionItemId: t, rawData: r }) {
            let { actionItemGroups: n, continuousParameterGroups: i } = e,
                o = [],
                a = (u) => (o.push((0, _h.mergeIn)(u, ["config"], { delay: 0, duration: 0 })), u.id === t);
            return (
                ...
                (0, _h.setIn)(r, ["actionLists"], { [e.id]: { id: e.id, actionItemGroups: [{ actionItems: o }] } })
            );
        }
        function xM(e, { basedOn: t }) {
            return (
                (e === Ft.EventTypeConsts.SCROLLING_IN_VIEW && (t === Ft.EventBasedOn.ELEMENT || t == null)) ||
    ...
    var Wh = s((fi) => {
        ...
        var Xh = De(),
            ...
            { optimizeFloat: li, applyEasing: Uh, createBezierEasing: $M } = Vh.IX2EasingUtils,
            { RENDER_GENERAL: ZM } = Xh.IX2EngineConstants,
            { getItemConfigByKey: Ba, getRenderType: JM, getStyleProp: e2 } = Vh.IX2VanillaUtils,
            t2 = (e, t) => {
                let {
                        position: r,
                        parameterId: n,
                ...
                for (let U = 0, { length: B } = i; U < B; U++) {
                    ...
                    if ((U === 0 && (I = K[0]), A >= ee)) {
                        ...
                        let x = i[U + 1],
                            y = x && A !== ee;
                        (C = y ? x.actionItems[0] : null), y && ((N = ee / 100), (q = (x.keyframe - ee) / 100));
                    }
                }
                let M = {};
                if (I && !C)
            ...
            r2 = (e, t) => {
                ...
                v != null && (P = v), (O = h ?? O), a === ZM ? (P = 0) : (o || R) && (P = O = 0);
                let { now: A } = t.payload;
                if (r && n) {
                    let I = A - (i + O);
                    if (u) {
                ...
                switch (t.type) {
                    ...
                    case KM: {
                        ...
                        return (0, _r.set)(e, r, {
                            ...
                            skipMotion: M,
                            skipToValue: U,
                            customEasingFn: Array.isArray(y) && y.length === 4 ? $M(y) : void 0,
                        });
                    }
                    case zM: {
                        let { instanceId: r, time: n } = t.payload;
                        return (0, _r.mergeIn)(e, [r], { active: !0, complete: !1, start: n });
                    }
                    case YM: {
    ...
    var Bh = s((di) => {
        ...
        var i2 = De(),
            { IX2_RAW_DATA_IMPORTED: o2, IX2_SESSION_STOPPED: a2, IX2_PARAMETER_CHANGED: s2 } = i2.IX2EngineActionTypes,
            u2 = (e = {}, t) => {
                switch (t.type) {
                    case o2:
    ...
    var jh = s((xj, en) => {
        ...
        (en.exports = _2), (en.exports.__esModule = !0), (en.exports.default = en.exports);
    });
    var Kh = s((Dj, kh) => {
        var y2 = _t(),
            I2 = Se(),
    ...
    var Ka = s((Bj, Eg) => {
        var vg = ka();
        function c1(e, t, r) {
            t == "__proto__" && vg ? vg(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r);
        }
        Eg.exports = c1;
    });
    var gg = s((Hj, hg) => {
        ...
        function v1(e, t, r) {
            var n = e[t];
            (!(p1.call(e, t) && f1(n, r)) || (r === void 0 && !(t in e))) && l1(e, t, r);
        }
        hg.exports = v1;
    });
    var Ig = s((jj, yg) => {
        ...
        function y1(e, t, r, n) {
            ...
            for (var i = -1, o = t.length, a = o - 1, u = e; u != null && ++i < o; ) {
                ...
                if (i != a) {
                    var E = u[c];
                    (f = n ? n(E, c, u) : void 0), f === void 0 && (f = _g(E) ? E : g1(t[i + 1]) ? [] : {});
                }
                E1(u, c, f), (u = u[c]);
            }
            return e;
    ...
    var wg = s((Yj, Rg) => {
        ...
        function M1(e) {
            ...
            var t = P1(e),
                r = [];
            for (var n in e) (n == "constructor" && (t || !D1.call(e, n))) || r.push(n);
            return r;
        }
        Rg.exports = M1;
    });
    ...
    var Gg = s((ek, Fg) => {
        ...
        function dF(e) {
            if (e == null) return !0;
            if (iF(e) && (nF(e) || typeof e == "string" || typeof e.splice == "function" || oF(e) || sF(e) || rF(e))) return !e.length;
            var t = tF(e);
    ...
    var $g = s((ak, Qg) => {
        ...
        function qF(e, t, r) {
            ...
            (t = Yg(t) || 0), RF(r) && ((E = !!r.leading), (v = "maxWait" in r), (o = v ? CF(Yg(r.maxWait) || 0, t) : o), (h = "trailing" in r ? !!r.trailing : h));
            function g(q) {
                var M = n,
                    U = i;
    ...
    var Jg = s((sk, Zg) => {
        ...
        function DF(e, t, r) {
            ...
            return LF(r) && ((n = "leading" in r ? !!r.leading : n), (i = "trailing" in r ? !!r.trailing : i)), PF(e, t, { leading: n, maxWait: t, trailing: i });
        }
        Zg.exports = DF;
    });
    var vi = s((J) => {
        ...
        var aG = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({ type: XF, payload: { hasBoundaryNodes: e, reducedMotion: t } });
        J.sessionInitialized = aG;
        var sG = () => ({ type: VF });
        J.sessionStarted = sG;
        var uG = () => ({ type: UF });
        J.sessionStopped = uG;
        var cG = ({ rawData: e, defer: t }) => ({ type: WF, payload: { defer: t, rawData: e } });
        ...
        var lG = ({
            ...
            verbose: u,
            rawData: c,
        }) => ({ type: BF, payload: { actionTypeId: e, actionListId: t, actionItemId: r, testManual: a, eventId: n, allowEvents: i, immediate: o, verbose: u, rawData: c } });
        J.playbackRequested = lG;
        var fG = (e) => ({ type: HF, payload: { actionListId: e } });
        J.stopRequested = fG;
        var dG = () => ({ type: jF });
        J.clearRequested = dG;
        var pG = (e, t) => ({ type: kF, payload: { target: e, listenerParams: t } });
        ...
        var TG = (e, t, r, n) => ({ type: eG, payload: { elementId: e, actionTypeId: t, current: r, actionItem: n } });
        J.elementStateChanged = TG;
        var mG = ({ actionListId: e, isPlaying: t }) => ({ type: tG, payload: { actionListId: e, isPlaying: t } });
        J.actionListPlaybackChanged = mG;
        var OG = ({ width: e, mediaQueries: t }) => ({ type: rG, payload: { width: e, mediaQueries: t } });
    ...
    var i_ = s((be) => {
        ...
        var AG = Xt(),
            ...
            { IX2_ID_DELIMITER: r_, HTML_ELEMENT: RG, PLAIN_OBJECT: wG, WF_PAGE: n_ } = bG.IX2EngineConstants;
        function CG(e, t, r) {
            e.style[t] = r;
        }
        function NG(e, t) {
        ...
        function LG({ id: e, selector: t }) {
            if (e) {
                ...
                if (e.indexOf(r_) !== -1) {
                    let n = e.split(r_),
                        i = n[0];
                    if (((r = n[1]), i !== document.documentElement.getAttribute(n_))) return null;
                }
        ...
        function UG(e) {
            return e != null && typeof e == "object" ? (e instanceof Element ? RG : wG) : null;
        }
    });
    var Qa = s((lk, a_) => {
        var WG = it(),
    ...
    var E_ = s((vk, v_) => {
        ...
        function p_(e, t, r, n, i) {
            ...
            for (r || (r = $G), i || (i = []); ++o < a; ) {
                var u = e[o];
                t > 0 && r(u) ? (t > 1 ? p_(u, t - 1, r, n, i) : QG(i, u)) : n || (i[i.length] = u);
            }
            return i;
        }
        v_.exports = p_;
    ...
    var m_ = s((gk, T_) => {
        ...
        function rX(e, t, r) {
            return (
                ...
                function () {
                    for (var n = arguments, i = -1, o = I_(n.length - t, 0), a = Array(o); ++i < o; ) a[i] = n[t + i];
                    i = -1;
    ...
    var R_ = s((yk, b_) => {
        var iX = S_(),
            ...
            aX = A_
                ? function (e, t) {
                      return A_(e, "toString", { configurable: !0, enumerable: !1, value: iX(t), writable: !0 });
                  }
                : oX;
        b_.exports = aX;
    });
    ...
    var Za = s((Rk, H_) => {
        ...
        function AX(e) {
            for (var t = e.name + "", r = B_[t], n = SX.call(B_, t) ? r.length : 0; n--; ) {
                var i = r[n],
                    o = i.func;
    ...
    var Y_ = s((Nk, z_) => {
        ...
        function LX(e) {
            ...
            return (t.__actions__ = PX(e.__actions__)), (t.__index__ = e.__index__), (t.__values__ = e.__values__), t;
        }
        z_.exports = LX;
    });
    var Z_ = s((qk, $_) => {
        ...
        function eV(e) {
            return kX(function (t) {
                ...
                for (n = a ? n : r; ++n < r; ) {
                    ...
                    c && ry(c[0]) && c[1] == (ZX | QX | $X | JX) && !c[4].length && c[9] == 1
    ...
    var ly = s((Mk, cy) => {
        ...
        function oV(e, t, r) {
            return (
                r === void 0 && ((r = t), (t = void 0)), r !== void 0 && ((r = es(r)), (r = r === r ? r : 0)), t !== void 0 && ((t = es(t)), (t = t === t ? t : 0)), iV(es(e), t, r)
            );
        }
        cy.exports = oV;
    });
        ...
        var Ve = Si(xr()),
            ...
            Fe = ({ store: e, event: t, element: r, eventStateKey: n }, i) => {
                ...
                return (
                    ...
                    (0, ts.stopActionGroup)({ store: e, eventId: a, eventTarget: r, eventStateKey: n, actionListId: u }),
                    (0, ts.startActionGroup)({ store: e, eventId: a, eventTarget: r, eventStateKey: n, actionListId: u }),
                    i
                );
            },
            ...
            MV = (e) => {
                ...
                return xV(t.getBoundingClientRect(), { left: 0, top: c, right: n, bottom: i - c });
            },
            Ry = (e) => (t, r) => {
            ...
            Ey =
                ...
                (t, r = {}) => {
                    ...
                    let g = (E ? c : (o * (c || 0)) / 100) / v,
                        ...
                        S,
                        P = 0;
                    r && ((R = h > r.percentTop), (S = r.scrollingDown !== R), (P = S ? h : r.anchorTop));
                    let O = u === yy ? h >= P + g : h <= P - g,
                        A = (0, Ve.default)({}, r, { percentTop: h, inBounds: O, anchorTop: P, scrollingDown: R });
            ...
            gy = (0, Ve.default)({}, is, {
                handler: FV((e, t) => {
                    let { elementVisible: r } = t,
                        ...
                        { ixData: o } = i.getState(),
                        { events: a } = o;
                    return !a[n.action.config.autoStopEventId] && t.triggered ? t : (n.eventTypeId === Iy) === r ? (Fe(e), (0, Ve.default)({}, t, { triggered: !0 })) : t;
                }),
            }),
            _y = 0.05,
            UV = {
                ...
                [SV]: {
                    ...
                    handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i }, o = { clientX: 0, clientY: 0, pageX: 0, pageY: 0 }) => {
                        let { basedOn: a, selectedAxis: u, continuousParameterGroupId: c, reverse: f, restingState: E = 0 } = r,
                            { clientX: v = o.clientX, clientY: h = o.clientY, pageX: g = o.pageX, pageY: R = o.pageY } = n,
                            S = u === "X_AXIS",
                            P = n.type === "mouseout",
                            O = E / 100,
                            A = c,
                        ...
                        switch (a) {
                            case Vt.EventBasedOn.VIEWPORT: {
                                O = S ? Math.min(v, window.innerWidth) / window.innerWidth : Math.min(h, window.innerHeight) / window.innerHeight;
                                break;
                            }
                            case Vt.EventBasedOn.PAGE: {
                                let { scrollLeft: C, scrollTop: N, scrollWidth: q, scrollHeight: M } = tn();
                        ...
                        return (
                            ...
                            (a !== Vt.EventBasedOn.ELEMENT || I || I !== o.elementHovered) && ((O = f ? 1 - O : O), e.dispatch((0, Ti.parameterChanged)(A, O))),
                ...
                [RV]: {
                    ...
                    handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, i = { scrollPercent: 0 }) => {
                        let { scrollLeft: o, scrollTop: a, scrollWidth: u, scrollHeight: c, clientHeight: f } = tn(),
                            {
                                basedOn: E,
                                selectedAxis: v,
                        ...
                        if (E === Vt.EventBasedOn.VIEWPORT) {
                            let C = I ? o / u : a / c;
                            return C !== i.scrollPercent && t.dispatch((0, Ti.parameterChanged)(h, C)), { scrollPercent: C };
                        } else {
                            let C = dy(n, h),
                            ...
                            return y !== i.scrollPercent && t.dispatch((0, Ti.parameterChanged)(C, y)), { scrollPercent: y };
                        }
                    },
                },
                [Iy]: gy,
                ...
                [Ty]: { types: "readystatechange IX2_PAGE_UPDATE", handler: ze(rn, XV(Fe)) },
                [my]: { types: "readystatechange IX2_PAGE_UPDATE", handler: ze(rn, VV(Fe)) },
            };
        Ai.default = UV;
    });
    var os = s((St) => {
        ...
        var BV = Qe(xr()),
            ...
            as = (e) => JV.includes(e),
            { COLON_DELIMITER: ss, BOUNDARY_SELECTOR: bi, HTML_ELEMENT: Py, RENDER_GENERAL: eU, W_MOD_IX: Cy } = Ye.IX2EngineConstants,
            {
            ...
            { isPluginType: cs, createPluginInstance: ls, getPluginDuration: vU } = qy.IX2VanillaPlugins,
            Ny = navigator.userAgent,
            EU = Ny.match(/iPad/i) || Ny.match(/iPhone/),
            hU = 12;
        function gU(e) {
            Ut({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: IU }),
                Ut({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: TU }),
        ...
        function _U(e) {
            Ut({
                ...
                onChange: () => {
                    Ni(e), Ly({ store: e, elementApi: ye }), Ci({ store: e, allowEvents: !0 }), xy();
                },
            });
        }
        function yU(e, t) {
        ...
        function TU(e, t) {
            let { actionTypeId: r, actionListId: n, actionItemId: i, eventId: o, allowEvents: a, immediate: u, testManual: c, verbose: f = !0 } = e,
                { rawData: E } = e;
            if (n && i && E && u) {
                let v = E.actionLists[n];
                v && (E = sU({ actionList: v, actionItemId: i, rawData: E }));
            }
            if ((Ci({ store: t, rawData: E, allowEvents: a, testManual: c }), (n && r === Ye.ActionTypeConsts.GENERAL_START_ACTION) || as(r))) {
                fs({ store: t, actionListId: n }), My({ store: t, actionListId: n, eventId: o });
                let v = ds({ store: t, eventId: o, actionListId: n, immediate: u, verbose: f });
                f && v && t.dispatch((0, Ee.actionListPlaybackChanged)({ actionListId: n, isPlaying: !u }));
            }
        }
        ...
        function Ci({ store: e, rawData: t, allowEvents: r, testManual: n }) {
            ...
            t && e.dispatch((0, Ee.rawDataImported)(t)),
                i.active ||
                    ...
                    r && (CU(e), SU(), e.getState().ixSession.hasDefinedMediaQueries && _U(e)),
        ...
        function AU(e, t) {
            let r = (n) => {
                ...
                i.active && (e.dispatch((0, Ee.animationFrameChanged)(n, o)), t ? yU(e, r) : requestAnimationFrame(r));
            };
        ...
        function RU({ store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: a, smoothing: u, restingValue: c }) {
            ...
            O.forEach((C) => {
                ...
                q.forEach((M) => {
                    ...
                    if (((S[K] = wU(S[K], N, M)), !R[K])) {
                        R[K] = !0;
                        let { config: x } = M;
                        Ri({ config: x, event: h, eventTarget: r, elementRoot: ee, elementApi: ye }).forEach((y) => {
        ...
        function qU(e) {
            ...
            NU.forEach((r) => {
                window.addEventListener(r, t), e.dispatch((0, Ee.eventListenerAdded)(window, [r, t]));
            }),
                t();
        }
        function Dy(e) {
        ...
        function DU({ logic: e, store: t, events: r }) {
            ...
            (0, on.default)(u, (v, h) => {
                ...
                dU(P, o.mediaQueryKeys) || t.dispatch((0, Ee.mediaQueriesDefined)()),
                    ...
                    (R.actionTypeId === Ye.ActionTypeConsts.GENERAL_START_ACTION || as(R.actionTypeId)) && My({ store: t, actionListId: O, eventId: S });
            });
            let c = (v) => {
                    ...
                    LU(u, (g, R, S) => {
                        ...
                        let C = (N = {}) => {
                            let q = i({ store: t, element: g, event: P, eventConfig: N, nativeEvent: v, eventStateKey: S }, O);
                            pU(q, O) || t.dispatch((0, Ee.eventStateChanged)(S, q));
                        };
                        A.actionTypeId === Ye.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION ? (Array.isArray(P.config) ? P.config : [P.config]).forEach(C) : C();
                    });
                },
                f = (0, QV.default)(c, hU),
                E = ({ target: v = document, types: h, throttle: g }) => {
                    h.split(" ")
                        ...
                        .forEach((R) => {
                            let S = g ? f : c;
                            v.addEventListener(R, S), t.dispatch((0, Ee.eventListenerAdded)(v, [R, S]));
                        });
                };
        ...
        function MU(e) {
            ...
            for (let n in e) {
                ...
                t[a] ||
                    ((i === Ye.EventTypeConsts.MOUSE_CLICK || i === Ye.EventTypeConsts.MOUSE_SECOND_CLICK) &&
            ...
            if (c && c.useFirstGroupAsInitialState) {
                ...
                f.forEach((v) => {
                    ...
                    let { config: g, actionTypeId: R } = v,
                        S = (g == null || (h = g.target) === null || h === void 0 ? void 0 : h.useEventTarget) === !0 ? { target: u.target, targets: u.targets } : g,
        ...
        function Fy({ store: e }) {
            ...
            (0, on.default)(t, (r) => {
                if (!r.continuous) {
                    ...
                    vs(r, e), i && e.dispatch((0, Ee.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
                }
            });
        }
        function fs({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i }) {
            ...
            (0, on.default)(o, (c) => {
                ...
                if (c.actionListId === i && c.eventId === t && E) {
                    ...
                    vs(c, e), c.verbose && e.dispatch((0, Ee.actionListPlaybackChanged)({ actionListId: i, isPlaying: !1 }));
                }
            });
        }
        function ds({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o = 0, immediate: a, verbose: u }) {
            var c;
            let { ixData: f, ixSession: E } = e.getState(),
                { events: v } = f,
                h = v[t] || {},
            ...
            o >= S.length && (0, Ot.default)(h, "config.loop") && (o = 0), o === 0 && P && o++;
            let A = (o === 0 || (o === 1 && P)) && as((c = h.action) === null || c === void 0 ? void 0 : c.actionTypeId) ? h.config.delay : void 0,
            ...
            return (
                I.forEach((M, U) => {
                    ...
                    Ri({ config: B, event: h, eventTarget: r, elementRoot: y, elementApi: ye }).forEach((D, F) => {
        ...
        function ps(e) {
            ...
            let { store: r, computedStyle: n } = e,
                i = (0, HV.default)(e, ZV),
                { element: o, actionItem: a, immediate: u, pluginInstance: c, continuous: f, restingValue: E, eventId: v } = i,
                h = !f,
                g = rU(),
                ...
                N;
            if (C && f)
                switch ((t = P.events[v]) === null || t === void 0 ? void 0 : t.eventTypeId) {
            ...
            if (
                (r.dispatch((0, Ee.instanceAdded)((0, BV.default)({ instanceId: g, elementId: O, origin: q, refType: I, skipMotion: C, skipToValue: N }, i))),
            ...
            Ut({ store: r, select: ({ ixInstances: M }) => M[g], onChange: Xy }), h && r.dispatch((0, Ee.instanceStarted)(g, S.tick));
        }
        function vs(e, t) {
            Gy(document.body, "ix2-animation-stopping", { instanceId: e.id, state: t.getState() });
        ...
        function Xy(e, t) {
            ...
            if (wi(M, C.mediaQueryKey) && (n || r || i)) {
                ...
                if (i) {
                    if (S) {
                        let U = ds({ store: t, eventId: v, eventTarget: h, eventStateKey: g, actionListId: R, groupIndex: E + 1, verbose: O });
                        O && !U && t.dispatch((0, Ee.actionListPlaybackChanged)({ actionListId: R, isPlaying: !1 }));
                    }
                    vs(e, t);
                }
            }
    ...
    var Ky = s((Uk, ky) => {
        ...
        yr.define(
            ...
            (ky.exports = function (e, t) {
                ...
                function g() {
                    (i = o && yr.env("design")), (h = yr.env("slug") || a.pathname || ""), yr.scroll.off(S), (v = []);
                        ...
                        if (L !== "") {
                            ...
                            D.length &&
                                ...
                                window.setTimeout(
                                    function () {
                                        q(D, function () {
                                            I(D, "add"), D.get(0).focus({ preventScroll: !0 }), I(D, "remove");
                                        });
                                    },
                                    x ? 0 : 300
                                ));
                ...
                function q(x, y) {
                    ...
                    if (L !== D) {
                        var F = U(x, L, D),
                            ...
                            z = function () {
                                var ie = Date.now() - j;
                                window.scroll(0, B(L, D, ie, F)), ie <= F ? u(z) : typeof y == "function" && y();
                            };
                        u(z);
                    }
                }
        ...
        jU.define(
            ...
            (Qy.exports = function (e) {
                ...
                function n(o) {
                    ...
                    function v(P) {
                        var O = P.touches;
                        (O && O.length > 1) || ((a = !0), O ? ((u = !0), (f = O[0].clientX)) : (f = P.clientX), (E = f));
                    }
                    function h(P) {
                        if (a) {
                            ...
                            var O = P.touches,
                                ...
                                I = A - E;
                            (E = A), Math.abs(I) > c && r && String(r()) === "" && (i("swipe", P, { direction: I > 0 ? "right" : "left" }), R());
                        }
                    }
                    function g(P) {
    ...
    var Jy = s((Hk, Zy) => {
        ...
        At.define(
            ...
            (Zy.exports = function (e, t) {
                ...
                function N() {
                    (f = v && At.env("design")), (E = At.env("editor")), (u = e(document.body)), (c = o.find(g)), c.length && (c.each(B), q(), M());
                }
                function q() {
                    At.resize.off(U);
                }
                ...
                function B(d, X) {
                    var W = e(X),
                        V = e.data(X, g);
                    V || (V = e.data(X, g, { open: !1, el: W, config: {}, selectedIdx: -1 })),
                    ...
                    fe && fe.attr("href") === "/" && fe.attr("aria-label") == null && fe.attr("aria-label", "home"),
                        ...
                        f
                            ...
                            : (x(V), V.button.on("click" + g, ie(V)), V.menu.on("click" + g, "a", we(V)), V.button.on("keydown" + g, D(V)), V.el.on("keydown" + g, F(V))),
                        Y(d, X);
                }
                function ee(d, X) {
                    var W = e.data(X, g);
                ...
                function D(d) {
                    return function (X) {
                        switch (X.keyCode) {
                            ...
                            case Re.END:
                                return d.open
                                    ? (X.keyCode === Re.END ? (d.selectedIdx = d.links.length - 1) : (d.selectedIdx = 0), j(d), X.preventDefault(), X.stopPropagation())
                ...
                function F(d) {
                    return function (X) {
                        if (d.open)
                            switch (((d.selectedIdx = d.links.index(document.activeElement)), X.keyCode)) {
                                case Re.HOME:
                                case Re.END:
                ...
                function Ge(d) {
                    return (
                        ...
                        function (X) {
                            var W = e(X.target);
                            (E && W.closest(".w-editor-bem-EditorOverlay").length) || Te(d, W);
                        }
                    );
                }
                ...
                function vt(d, X) {
                    if (d.open) return;
                    (d.open = !0), d.menu.each(Wt), d.links.addClass(A), d.dropdowns.addClass(S), d.dropdownToggle.addClass(P), d.dropdownList.addClass(O), d.button.addClass(R);
                    var W = d.config,
                        V = W.animation;
                    ...
                    var fe = Ir(d),
                        ...
                        l = d.el.height(),
                        p = d.el[0];
                    if ((Y(0, p), I.intro(0, p), At.redraw.up(), f || o.on("click" + g, d.outside), X)) {
                        w();
                        return;
                    }
                    var _ = "transform " + W.duration + "ms " + W.easing;
                    if ((d.overlay && ((C = d.menu.prev()), d.overlay.show().append(d.menu)), W.animOver)) {
                        n(d.menu)
                            .add(_)
                ...
                function Ir(d) {
                    ...
                    return X.animOver ? d.menu.height(W) : d.el.css("position") !== "fixed" && (W -= d.el.outerHeight(!0)), d.overlay && d.overlay.height(W), W;
                }
                function ce(d, X) {
                    if (!d.open) return;
                    (d.open = !1), d.button.removeClass(R);
                    var W = d.config;
                    if (((W.animation === "none" || !n.support.transform || W.duration <= 0) && (X = !0), I.outro(0, d.el[0]), o.off("click" + g, d.outside), X)) {
                        n(d.menu).stop(), p();
                        return;
                    }
                    ...
                    function p() {
                        d.menu.height(""),
                            ...
                            d.overlay && d.overlay.children().length && (C.length ? d.menu.insertAfter(C) : d.menu.prependTo(d.parent), d.overlay.attr("style", "").hide()),
    ...
    events: {
        e: {
            ...
            action: {
                ...
                config: { delay: 0, easing: "", duration: 0, actionListId: "a-2", affectedElements: {}, playInReverse: false, autoStopEventId: "e-2" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3", appliesTo: "PAGE", styleBlockIds: [] }],
        ...
        "e-2": {
            ...
            action: {
                id: "",
                actionTypeId: "GENERAL_START_ACTION",
                config: { delay: 0, easing: "", duration: 0, actionListId: "a", affectedElements: {}, playInReverse: false, autoStopEventId: "e" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1682229108843,
        },
        "e-3": {
            id: "e-3",
            name: "",
        ...
        "e-4": {
            ...
            action: { id: "", actionTypeId: "GROW_EFFECT", instant: false, config: { actionListId: "growIn", autoStopEventId: "e-5" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|c7be4210-cbec-9f81-ada1-8324d8fadda0", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|c7be4210-cbec-9f81-ada1-8324d8fadda0", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 4, scrollOffsetUnit: "%", delay: 200, direction: null, effectIn: true },
            createdOn: 1682246362091,
        },
        "e-5": {
            id: "e-5",
            name: "",
            ...
            action: { id: "", actionTypeId: "GROW_EFFECT", instant: false, config: { actionListId: "growOut", autoStopEventId: "e-4" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|c7be4210-cbec-9f81-ada1-8324d8fadda0", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|c7be4210-cbec-9f81-ada1-8324d8fadda0", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 4, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246362126,
        },
        "e-6": {
            id: "e-6",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SHRINK_EFFECT", instant: false, config: { actionListId: "shrinkIn", autoStopEventId: "e-7" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|de4fdb37-0ea6-c137-8b2c-289882418ace", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|de4fdb37-0ea6-c137-8b2c-289882418ace", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 7, scrollOffsetUnit: "%", delay: 200, direction: null, effectIn: true },
            createdOn: 1682246424252,
        },
        "e-7": {
            id: "e-7",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-6" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|de4fdb37-0ea6-c137-8b2c-289882418ace", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|de4fdb37-0ea6-c137-8b2c-289882418ace", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 7, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246424252,
        },
        "e-10": {
            id: "e-10",
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", instant: false, config: { actionListId: "slideInBottom", autoStopEventId: "e-11" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|3dd264be-44a9-e6fe-f706-95b73bd6780f", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|3dd264be-44a9-e6fe-f706-95b73bd6780f", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: true },
            createdOn: 1682246690868,
        },
        "e-11": {
            id: "e-11",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-10" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|3dd264be-44a9-e6fe-f706-95b73bd6780f", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|3dd264be-44a9-e6fe-f706-95b73bd6780f", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-12": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", instant: false, config: { actionListId: "slideInBottom", autoStopEventId: "e-13" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|9db7ad54-ddfd-2222-db67-c8ff1aec5948", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|9db7ad54-ddfd-2222-db67-c8ff1aec5948", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: true },
            createdOn: 1682246704138,
        },
        "e-13": {
            id: "e-13",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-12" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|9db7ad54-ddfd-2222-db67-c8ff1aec5948", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|9db7ad54-ddfd-2222-db67-c8ff1aec5948", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
        ...
        "e-14": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", instant: false, config: { actionListId: "slideInBottom", autoStopEventId: "e-15" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|333774dc-1b83-9439-77a9-87b8a6963d38", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|333774dc-1b83-9439-77a9-87b8a6963d38", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: "BOTTOM", effectIn: true },
            createdOn: 1682246715556,
        },
        "e-15": {
            id: "e-15",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-14" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|333774dc-1b83-9439-77a9-87b8a6963d38", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|333774dc-1b83-9439-77a9-87b8a6963d38", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246715590,
        },
        "e-16": {
            id: "e-16",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-17" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|a420d85d-74ae-e887-e043-e40bd95f00de", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|a420d85d-74ae-e887-e043-e40bd95f00de", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 12, scrollOffsetUnit: "%", delay: 60, direction: null, effectIn: true },
            createdOn: 1682246732814,
        },
        "e-17": {
            id: "e-17",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-16" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|a420d85d-74ae-e887-e043-e40bd95f00de", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|a420d85d-74ae-e887-e043-e40bd95f00de", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246732849,
        },
        "e-18": {
            id: "e-18",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-19" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|ad1858f5-6323-3e35-d285-5f3ed865b210", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|ad1858f5-6323-3e35-d285-5f3ed865b210", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 12, scrollOffsetUnit: "%", delay: 60, direction: null, effectIn: true },
            createdOn: 1682246740700,
        },
        "e-19": {
            id: "e-19",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-18" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|ad1858f5-6323-3e35-d285-5f3ed865b210", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|ad1858f5-6323-3e35-d285-5f3ed865b210", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
        ...
        "e-20": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-21" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb6", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb6", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 12, scrollOffsetUnit: "%", delay: 60, direction: null, effectIn: true },
            createdOn: 1682246749026,
        },
        "e-21": {
            id: "e-21",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-20" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb6", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb6", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246749060,
        },
        "e-22": {
            id: "e-22",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-23" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb8", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb8", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 12, scrollOffsetUnit: "%", delay: 60, direction: null, effectIn: true },
            createdOn: 1682246759010,
        },
        "e-23": {
            id: "e-23",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-22" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb8", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|f343a0b4-348e-0a45-1657-166d8547acb8", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246759045,
        },
        "e-24": {
            id: "e-24",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-25" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f82e", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f82e", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 12, scrollOffsetUnit: "%", delay: 60, direction: null, effectIn: true },
            createdOn: 1682246774589,
        },
        "e-25": {
            id: "e-25",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-24" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f82e", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f82e", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682246774590,
        },
        "e-26": {
            id: "e-26",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-27" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f830", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f830", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 12, scrollOffsetUnit: "%", delay: 60, direction: null, effectIn: true },
            createdOn: 1682246782826,
        },
        "e-27": {
            id: "e-27",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-26" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f830", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|1705afa1-3c61-5aca-2a5d-5f780270f830", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
        ...
        "e-28": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SHRINK_EFFECT", instant: false, config: { actionListId: "shrinkIn", autoStopEventId: "e-29" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|9dfe3862-b786-dec1-a46e-2361e0ab6040", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|9dfe3862-b786-dec1-a46e-2361e0ab6040", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: true },
            createdOn: 1682247393089,
        },
        "e-29": {
            id: "e-29",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "SHRINK_EFFECT", instant: false, config: { actionListId: "shrinkOut", autoStopEventId: "e-28" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|9dfe3862-b786-dec1-a46e-2361e0ab6040", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|9dfe3862-b786-dec1-a46e-2361e0ab6040", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
        ...
        "e-30": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SHRINK_EFFECT", instant: false, config: { actionListId: "shrinkIn", autoStopEventId: "e-31" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|a1d3c262-95f2-6b97-001c-4538986ff5fd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|a1d3c262-95f2-6b97-001c-4538986ff5fd", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: true },
            createdOn: 1682247398160,
        },
        "e-31": {
            id: "e-31",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "SHRINK_EFFECT", instant: false, config: { actionListId: "shrinkOut", autoStopEventId: "e-30" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|a1d3c262-95f2-6b97-001c-4538986ff5fd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|a1d3c262-95f2-6b97-001c-4538986ff5fd", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
        ...
        "e-32": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-33" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|45442669-7a60-6e71-bbbb-b16d737bf990", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|45442669-7a60-6e71-bbbb-b16d737bf990", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 296, direction: null, effectIn: true },
            createdOn: 1682247889298,
        },
        "e-33": {
            id: "e-33",
            name: "",
            animationType: "preset",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-32" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|45442669-7a60-6e71-bbbb-b16d737bf990", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|45442669-7a60-6e71-bbbb-b16d737bf990", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1682247889299,
        },
        "e-34": {
            id: "e-34",
            name: "",
            ...
            action: {
                id: "",
                actionTypeId: "GENERAL_START_ACTION",
                config: { delay: 0, easing: "", duration: 0, actionListId: "a-7", affectedElements: {}, playInReverse: false, autoStopEventId: "e-35" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|10414909-27a9-651f-e4d9-09e396204046", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|10414909-27a9-651f-e4d9-09e396204046", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: 0, direction: null, effectIn: true },
            createdOn: 1682249863188,
        },
        "e-35": {
            id: "e-35",
            name: "",
            ...
            action: {
                id: "",
                actionTypeId: "GENERAL_START_ACTION",
                config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-34" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|10414909-27a9-651f-e4d9-09e396204046", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|10414909-27a9-651f-e4d9-09e396204046", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1682249863224,
        },
        "e-36": {
            id: "e-36",
            name: "",
            ...
            action: {
                id: "",
                actionTypeId: "GENERAL_START_ACTION",
                config: { delay: 0, easing: "", duration: 0, actionListId: "a-7", affectedElements: {}, playInReverse: false, autoStopEventId: "e-37" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|181bd657-82db-c54a-7739-77d48e5e85fe", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|181bd657-82db-c54a-7739-77d48e5e85fe", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1682250484435,
        },
        "e-37": {
            id: "e-37",
            name: "",
            ...
            action: {
                id: "",
                actionTypeId: "GENERAL_START_ACTION",
                config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-36" },
            },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "643a5af117fe0c125ca73ea3|181bd657-82db-c54a-7739-77d48e5e85fe", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "643a5af117fe0c125ca73ea3|181bd657-82db-c54a-7739-77d48e5e85fe", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1682250484436,
        },
    },
    actionLists: {
        "a-2": {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { id: "643a5af117fe0c125ca73ea3|fc73af2d-3099-575b-dfe1-61b5af6188f9" },
                                xValue: -500,
                                xUnit: "px",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 500, target: { id: "643a5af117fe0c125ca73ea3|fc73af2d-3099-575b-dfe1-61b5af6188f9" }, value: 0, unit: "" },
                        },
                    ],
                },
                {
        ...
        a: {
                    ...
                    actionItems: [
                        {
                            id: "a-n-2",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { id: "643a5af117fe0c125ca73ea3|e9737472-11e0-875f-d6ee-f7e202d7b929" }, value: 0, unit: "" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "easeInOut",
                                duration: 2000,
                                target: { id: "643a5af117fe0c125ca73ea3|e9737472-11e0-875f-d6ee-f7e202d7b929" },
                                xValue: -38,
                                yValue: 14,
                                xUnit: "deg",
                                yUnit: "deg",
            ...
            useFirstGroupAsInitialState: true,
            createdOn: 1682229115168,
        },
        "a-4": {
            id: "a-4",
            title: "Grid Row Animation",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { selector: ".grid-image", selectorGuids: ["df9a5458-1c6d-d226-87cc-6cc943ada9b4"] },
                                        xValue: 0,
                                        xUnit: "%",
                                        yUnit: "PX",
                                        zUnit: "PX",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        duration: 500,
                                        target: {
                                            selector: ".grid-image.grid-row-bottom",
                                            selectorGuids: ["df9a5458-1c6d-d226-87cc-6cc943ada9b4", "319bf3ca-e60f-3ccd-7f5e-973a89a9832e"],
                                        },
                                        xValue: 0,
                                        xUnit: "%",
                                        yUnit: "PX",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { id: "643a5af117fe0c125ca73ea3|d789437f-b85e-9c78-abba-32a5ef5afc4f" },
                                        yValue: 0,
                                        xUnit: "PX",
                                        yUnit: "%",
                                        zUnit: "PX",
            ...
            createdOn: 1682235125294,
        },
        "a-7": {
            id: "a-7",
            title: "Email Link Animation in",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".email", selectorGuids: ["94414526-c107-9bb3-f590-5f74c4e71649"] },
                                globalSwatchId: "",
                                rValue: 255,
                                bValue: 255,
                                gValue: 255,
            ...
            useFirstGroupAsInitialState: true,
            createdOn: 1682249906195,
        },
        "a-8": {
            id: "a-8",
            title: "Email Link Animation out",
            actionItemGroups: [
                {
                    actionItems: [
                        {
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        ...
                        {
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "inQuart", duration: 1000, target: { id: "N/A", appliesTo: "TRIGGER_ELEMENT", useEventTarget: true }, value: 0 },
                        },
                    ],
                },
            ],
            ...
            actionItemGroups: [
                ...
                },
                {
                    actionItems: [
                        {
                            actionTypeId: "TRANSFORM_SCALE",
                            config: { delay: 0, duration: 0, target: { id: "N/A", appliesTo: "TRIGGER_ELEMENT", useEventTarget: true }, xValue: 1.25, yValue: 1.25 },
                        },
                    ],
                },
                {
